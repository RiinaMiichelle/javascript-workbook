...
const weatherStates = [];
const seenWeatherStates = {};

for (let i=0; i < weather.length; i++) {
  const weatherState = weather[i].weather_state_name;
  if (!seenWeatherStates[weatherState]) {
    seenWeatherStates[weatherState] = true;
